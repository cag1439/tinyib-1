...
define('TINYIB_DATEFMT', ''); // Date and time format  (see php.net/strftime)
...
define('TINYIB_BOARDDESC', ''); // Displayed below logo in page headers
...
define('TINYIB_BANMESSAGE', false);    // Allow staff to append a custom message to posts when banning users
...
$tinyib_hidefieldsop = array('email', 'password');       // Fields to hide when creating a new thread - e.g. array('name', 'email', 'subject', 'message', 'file', 'embed', 'password')
$tinyib_hidefields = array('email', 'subject','file', 'embed','password');         // Fields to hide when replying
...
define('TINYIB_MAXMESSAGE', 16000);    // Maximum message length  [0 to disable]
...
// File control
define('TINYIB_MAXKB', 0);         // Maximum file size in kilobytes  [0 to disable]
...
define('TINYIB_UPLOADVIAURL', true); // Allow files to be uploaded via URL
...
define('TINYIB_MAXWOP', 100);         // Width
define('TINYIB_MAXHOP', 100);         // Height

// Thumbnail size - reply
define('TINYIB_MAXW', 100);           // Width
define('TINYIB_MAXH', 100);           // Height

// Tripcode seed - Must not change once set!
define('TINYIB_TRIPSEED', 'sdgsdfgegtgwrewg');        // Enter some random text  (used when generating secure tripcodes, hashing passwords and hashing IP addresses)
...
define('TINYIB_DBMODE', 'sqlite3');     // Mode
//   Table names
...
define('TINYIB_DBDRIVER', '');   // PDO driver to use (mysql / pgsql / sqlite / etc.)
